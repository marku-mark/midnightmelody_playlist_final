...
const playlistData = {
  ...
  songs: [
    ...
    },
    {
      ...
      color:  ['#e8849e', '#c0607e'],
      audio:  'songs/Twilight_bellas_Lullaby-Brussells_Philharmonic_Dirk_Bross.aac',
    ...
    },
    {
      ...
      color:  ['#2d5a27', '#4a7c59'],
      audio:  'songs/Full_Moon-The_Black_Ghosts.aac',
    ...
    },
    {
      ...
      artist: 'SYML',
      color:  ['#e8c87a', '#d4a853'],
      audio:  'songs/Wheres_My_Love_acoustic-Syml.aac',
    ...
    },
    {
      ...
      artist: 'SYML',
      color:  ['#5c6bc0', '#3949ab'],
      audio:  'songs/Wheres_My_Love-Syml.aac',
    ...
    },
    {
      ...
      color:  ['#81d4fa', '#0288d1'],
      audio:  'songs/Ontario-Lowswimmer_Novo_Amor.aac',
    ...
    },
    {
      ...
      color:  ['#8b9fe8', '#5b6fd4'],
      audio:  'songs/A_Thousand_Years-Christina_Perri.aac',
    ...
    },
    {
      ...
      artist: 'Bruno Mars',
      color:  ['#f4b98e', '#e8834a'],
      audio:  'songs/It _Will_Rain-Bruno_Mars.aac',
    ...
    },
    {
      ...
      color:  ['#e8849e', '#c0607e'],
      audio:  'songs/Turning_Page-Sleeping_At_Last.aac',
    ...
    },
    {
      ...
      color:  ['#2d5a27', '#4a7c59'],
      audio:  'songs/Requiem_On_Water-Imperial_Mammoth.aac',
    ...
    },
    {
      ...
      artist: 'Iron & Wine',
      color:  ['#e8c87a', '#d4a853'],
      audio:  'songs/Flightless_Bird_American_Mouth_wedding_Version-Iron_Wine.aac',
    ...
    },
    {
      ...
      color:  ['#5c6bc0', '#3949ab'],
      audio:  'songs/Cold-Aqualung_Lucy_Schwartz.aac',
    ...
    },
    {
      ...
      color:  ['#81d4fa', '#0288d1'],
      audio:  'songs/A_Nova_Vida_from_the_Twilight_Saga_Breaking_Dawn.aac',
    ...
    },
    {
      ...
      artist: 'Grizzly Bear',
      color:  ['#f4b98e', '#e8834a'],
      audio:  'songs/Slow_Life (with_Victoria_Legrand).aac',
    ...
    },
    {
      ...
      artist: 'Sleeping At Last',
      color:  ['#e8849e', '#c0607e'],
      audio:  'songs/Hearing-Sleeping_At_Last.aac',
    ...
    },
    {
      ...
      artist: 'Paramore',
      color:  ['#2d5a27', '#4a7c59'],
      audio:  'songs/Decode-Paramore.aac',
    ...
    },
    {
      ...
      artist: 'LINKIN PARK',
      color:  ['#e8c87a', '#d4a853'],
      audio:  'songs/Leave_Out_All_The_Rest_twilight_Soundtrack_Version-Linkin_Park.aac',
    ...
    },
    {
      ...
      artist: 'Metric',
      color:  ['#5c6bc0', '#3949ab'],
      audio:  'songs/Eclipse_all_Yours-Metric.aac',
    ...
    },
    {
      ...
      artist: 'Christina Perri',
      color:  ['#81d4fa', '#0288d1'],
      audio:  'songs/A_Thousand_Years_Pt2_feat-Steve_Kazee-Christina_Perri.aac',
    ...
    },
    {
      ...
      artist: 'Paramore',
      color:  ['#8b9fe8', '#5b6fd4'],
      audio:  'songs/I_Caught_Myself-Paramore.aac',
